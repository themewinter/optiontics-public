...
export default function DescriptionControl({
    attrKey,
    control,
    attributes,
    setAttribute,
    ...
    return (
        ...
        <Input
            ...
            placeholder={__("Enter description here..", "optiontics")}
                onChange={(e) => setAttribute(attrKey as string, e.target.value as string)}
            />
        </div>
    );
}
