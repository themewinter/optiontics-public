 ...
 * Textarea Component
 *
 * Renders a labeled textarea field with optional description and price display.
 * Supports showing prices either beside the label ("with_title") or beside the textarea field ("with_option").
 */
