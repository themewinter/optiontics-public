 ...
 * Telephone Component
 *
 * Renders a labeled telephone input field with optional description and price display.
 * Supports showing prices either beside the label ("with_title")
 * or beside the telephone input field ("with_option").
 */
export default function Component(props: ComponentProps) {
    ...
    return (
        ...
        >
            ...
            {/* Telephone input field with optional price display (if pricePosition === "with_option") */}
